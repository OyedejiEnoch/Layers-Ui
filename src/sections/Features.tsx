    ...
    return <section className="py-24">
        <div className="container">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8" >
                ...
                <FeatureCard title="Interactive Prototyping" description="Enagage your clients with prototypes that reacts to user actions" className="md:col-span-2 lg:col-span-1 group" >
                    <div className="aspect-video ">
                        <p className="text-4xl font-extrabold text-white/20 group-hover:text-white/10 transition duration-500 text-center">We&apos;ve achieved{" "}
                        <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text bg-transparent relative">
                            <span>incredible</span> 
                            <video src={'/assets/gif-incredible.mp4'} autoPlay loop muted playsInline className="absolute bottom-full left-1/2 -translate-x-1/2 
                            rounded-2xl shadow-xl opacity-0 pointer-events-none group-hover:opacity-100 transition duration-500" />
                            </span>{" "}
                            growth this year
                        </p>
                    </div>
                ...
                <FeatureCard title="Keyboard Quick Actions" description="Powerful commands to help you create designs more quickly"  className="md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-auto group" >
                    <div className="aspect-video flex items-center justify-center gap-4">
                        ...
                        <Key className="outline outline-2 outline-offset-4 outline-transparent group-hover:outline-lime-400 group-hover:translate-y-1 transition-all duration-500 delay-150">C</Key>
                    </div>
                </FeatureCard>
                ...
                <div className="mt-8 flex flex-wrap gap-2 justify-center ">
                    {features.map((feature)=>(
                        <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex px-2 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center
